...
class Pokedex:
    ...
    async def pokedex(self, ctx):
        ...
        if ctx.invoked_subcommand is None:
            await self.bot.say("Invalid usage")
    ...
    async def _pokemon2_pokedex(self, pokemon: str):
        ...
        async with aiohttp.get(url) as response:
            ...
            '''
            if info_search[0].find_all('th', attrs={'class': 'roundy'})[0].text.strip() == "Red":
                print(info_search[0].find_all('td', attrs={'class': 'roundy'})[0].text.strip())
            if info_search[1].find_all('th', attrs={'class': 'roundy'})[0].text.strip() == "Gold":
                print(info_search[1].find_all('td', attrs={'class': 'roundy'})[0].text.strip())
            if info_search[2].find_all('th', attrs={'class': 'roundy'})[0].text.strip() == "Ruby":
                print(info_search[2].find_all('td', attrs={'class': 'roundy'})[0].text.strip())
            if info_search[3].find_all('th', attrs={'class': 'roundy'})[0].text.strip() == "Diamond":
                print(info_search[3].find_all('td', attrs={'class': 'roundy'})[0].text.strip())
            if info_search[4].find_all('th', attrs={'class': 'roundy'})[0].text.strip() == "Black":
                print(info_search[4].find_all('td', attrs={'class': 'roundy'})[0].text.strip())
            if info_search[5].find_all('th', attrs={'class': 'roundy'})[0].text.strip() == "X":
                print(info_search[5].find_all('td', attrs={'class': 'roundy'})[0].text.strip())
            if info_search[6].find_all('th', attrs={'class': 'roundy'})[0].text.strip() == "Sun":
                print(info_search[6].find_all('td', attrs={'class': 'roundy'})[0].text.strip())
            '''
